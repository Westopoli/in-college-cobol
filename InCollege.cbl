      ...
      *> same shape STORE-SAVE-PROFILE used to have).
       ...
       ACCT-VALIDATE-PASSWORD.
           ...
           PERFORM VARYING I FROM 1 BY 1
               UNTIL I > PASS-LENGTH
               COMPUTE CHAR-CODE = FUNCTION ORD(PASSWORD(I:1)) - 1
      ...
      *> echoed because that behavior was required in Epic 1.
       ...
       IO-PROMPT-AND-READ.
           MOVE OUT-LINE TO PROMPT-TEXT
           MOVE SPACES TO OUT-LINE
           PERFORM IO-READ-LINE
           STRING FUNCTION TRIM(PROMPT-TEXT TRAILING) " "
               FUNCTION TRIM(IN-LINE)
               DELIMITED BY SIZE INTO OUT-LINE
           PERFORM IO-WRITE-LINE.
